...
@Entity
@Table(name= "Meetmedecin",catalog = "jardin")
...
public class Meetmedecin {
	...
	public int getIdmeetmed() {
		return idmeetmed;
	}



	public void setIdmeetmed(int idmeetmed) {
		this.idmeetmed = idmeetmed;
	}
	...
	public Meetmedecin(int idmeetmed, String datemeet, String maladie, String description, String madecin, String salle,
